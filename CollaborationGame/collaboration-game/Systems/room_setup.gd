...
func set_up_medieval_rooms():
	...
	var e_room = load("res://LevelParts/Dungeon/Rooms/Medieval/medieval_exit_room_w.tscn")
	var w_room = load("res://LevelParts/Dungeon/Rooms/Medieval/medieval_exit_room_e.tscn")
